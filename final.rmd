...
gnorm(mean_pt, s_pt, color = 'cyan') +
  ...
  xlab('points')
```
Analysis: From the data of XXXX to 20XX, we build the distribution graph, and we estimate that the winning point of 95% confidence interval should be between approximately 74 to 84.
