...
## Conclusion
In the world of soccer, everything is unpredictable and there are a lot more factors that could affect the trend of a season. For example, the transfers of a team could bring new players that strengthen the attack; the injuries of key players could stop the straight win. It is even more difficult to predict the winner of a future season. For example, Leicester City began the 2015-16 Premier League as 5000/1 outsiders, but they crowned the season at last.

From our analysis of the La Liga data, we are able to form predictions on the characteristics of the 2021 winner. <Question 1>. Secondly, we are able to say with 95% confidence that the champion team will have a top scorer with a higher proportion of goals than the average. This make sense if you consider that some of the top teams in the league have players who are know to make their team. For example, Lionel Messi played 16 years for Barcelona and he is the top scorerer in the team's history. Lastly we are also able to confirm with 95% confidence that the top teams of the league will have a higher possession rate than the rest of the league.
